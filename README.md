...
本机可视化编辑 React + Tailwind 组件。面向官方 DeepSeek Harness **0.1.5-rc.3**（`dsh-v0.1.5-rc.3`，`@deepseek-ai/dsh@0.1.5-rc.3`）。peer 仍钉 `@deepseek-ai/dsh-tools` `0.1.2-rc.1`，由 Host 提供，不装进 profile。`@deepseek-ai/cordis` `^4.0.2`。Node 22.14 或更新。
