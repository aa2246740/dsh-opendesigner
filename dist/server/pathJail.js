...
export class PathJailError extends Error {
    code = "PATH_JAIL";
    causeCode;
    constructor(message, causeCode) {
        super(message);
        this.name = "PathJailError";
        this.causeCode = causeCode;
    }
}
function lstatComponent(target) {
    try {
...
function assertNotLink(st, target) {
...
export function resolveProjectPath(projectRoot, requested) {
...
export function assertManagedPath(abs) {
    const st = lstatComponent(abs);
    if (st === null)
        return;
    assertNotLink(st, abs);
}
//# sourceMappingURL=pathJail.js.map