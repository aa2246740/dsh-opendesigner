...
export function snapshotJsxAsSvgDataUrl(elementId, jsx) {
    ...
    const textNodes = [
        ...
        ...lines.map((line, i) => `<text x="12" y="${52 + i * 16}" font-size="11" font-family="monospace" fill="#94a3b8">${escapeXml(line.slice(0, 90))}</text>`)
    ];
...
//# sourceMappingURL=jsxSnapshot.js.map