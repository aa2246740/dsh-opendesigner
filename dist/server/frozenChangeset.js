...
import { contentHash } from "./fileBytes.js";
export function fileModeOf(abs) {
    try {
...
export function fingerprintPresence(presence) {
...
export function hashFrozenChangeset(changeset) {
...
export function cloneFrozenChangeset(changeset) {
    const afterBytes = {};
...
//# sourceMappingURL=frozenChangeset.js.map